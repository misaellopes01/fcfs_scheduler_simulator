...
const task4 = new Task('Tarefa D', forTask4.start, forTask4.executionTime);
const task5 = new Task('Tarefa E', forTask5.start, forTask5.executionTime);
const task6 = new Task('Tarefa F', forTask6.start, forTask6.executionTime);
